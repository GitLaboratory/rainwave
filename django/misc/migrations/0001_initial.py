# Generated by Django 3.0.2 on 2020-02-05 08:24
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('directories', django.contrib.postgres.fields.ArrayField(base_field=models.CharField(max_length=1024), default=list, help_text='Array of directories containing MP3s for this station.', size=None)),
                ...
                ('position', models.SmallIntegerField(default=0, help_text='What position in the menu this station sits at.')),
                ...
                ('stream_suffix', models.CharField(help_text='Suffix to add to song titles when using LiquidSoap.', max_length=1024)),
                ...
                ('trim_events_after', models.DurationField(default=misc.models.default_history_trim)),
                ('trim_song_history_after', models.DurationField(default=misc.models.default_history_trim)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('stations', models.ManyToManyField(to='misc.Station')),
            ],
        ),
        migrations.CreateModel(
            name='ListenerCount',
