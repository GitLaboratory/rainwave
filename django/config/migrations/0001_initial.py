    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('subdirectory', models.TextField(blank=True, null=True)),
                ...
                ('site', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='config.Site')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='+', to='config.Station'),
        ),
        migrations.CreateModel(
            name='Relay',
            fields=[
        ...
        migrations.CreateModel(
            name='MusicDirectoryToStation',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('music_directory', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='config.MusicDirectory')),
                ('station', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='config.Station')),
            ],
        ),
        migrations.AddField(
            model_name='musicdirectory',
            name='primary_station',
            field=models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='primary_directory', to='config.Station'),
        ),
        migrations.AddField(
            model_name='musicdirectory',
            name='stations',
            field=models.ManyToManyField(through='config.MusicDirectoryToStation', to='config.Station'),
        ),
    ]
